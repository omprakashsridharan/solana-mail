...
impl Processor {
    ...
    fn process_send_mail(
        ...
        let data_length: DataLength =
            DataLength::try_from_slice(&sender_account.data.borrow()[..offset])?;

        let mut sender_data: MailAccount;
        ...
        let data_length: DataLength =
            DataLength::try_from_slice(&receiver_account.data.borrow()[..offset])?;

        let mut receiver_data: MailAccount;
    ...
    fn process_init_account(accounts: &[AccountInfo], program_id: &Pubkey) -> ProgramResult {
        ...
        let welcome_mail = Mail {
            ...
            body: String::from("This is the start of your private message on SolMail"),
            sent_date: "11/15/2021, 8:58:02 PM".to_string(),
        };
